 ...
 */
public class CustomTableHost extends TabHost implements
    ...
    public CustomTableHost(Context context) {
    ...
    public CustomTableHost(Context context, AttributeSet attrs) {
        super(context, attrs);
