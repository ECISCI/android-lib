...
public abstract class BaseRecyclerAdapter<T, F extends RecyclerView.ViewHolder> extends RecyclerView.Adapter<F> {
    ...
    private RecyclerItemClickListener<T, F> recItemClick;
    ...
    public void setRecItemClick(RecyclerItemClickListener<T, F> recItemClick) {

        this.recItemClick = recItemClick;
    }

    public RecyclerItemClickListener<T, F> getRecItemClick() {
        return recItemClick;
    }
